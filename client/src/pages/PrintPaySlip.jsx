  ...
  return (
    <div className='max-w-2xl mx-auto p-8 bg-white animate-fade-in'>
      <div className='text-center border-b border-slate-200 pb-6 mb-8'>
        ...
        <p className='text-slate-500text-sm mt-1'>{format(new Date(payslip.year, payslip.month -1), "MMMM yyyy  ")}</p>
      </div>
      ...
      <div className='rounded-xl border border-slate-200 overflow-hidden mb-8'>
        <table className='w-full text-sm'>
          ...
          <tbody>
            ...
            <tr className='border-t border-slate-100 '>
              <td className='py-3 px-4 text-slate-700'>Dedcutions</td>
              <td className='text-right py-3 px-4 text-slate-900 font-medium'>-${payslip.deductions?.toLocaleString()}</td>
            </tr>
            <tr className='border-t-2  border-slate-200 bg-slate-50 '>
              <td className='py-3 px-4 font-bold text-slate-900'>Dedcutions</td>
              <td className='text-right py-4 px-4 font-bold text-lg text-slate-900'>${payslip.netSalary?.toLocaleString()}</td>
            </tr>
          </tbody>
        </table>
      </div>
