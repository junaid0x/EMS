...
const ApplyLeaveModal = ({open, onClose, onSuccess}) => {
  ...
  return (
    <div onClick={onClose} className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm'>
        <div onClick={(e)=>e.stopPropagation()} className='bg-white relative rounded-2xl shadow-2xl w-full max-w-lg animate-fade-in'>
            {/* {Header} */}
            <div className='flex items-center justify-between p-6 pb-0'>
                <div>
                    <h2 className='text-lg font-semibold'>Apply for Leave</h2>
                    <p className='text-sm text-slate-400 mt-0.5'>Submit your request for approval</p>
                </div>
            ...
            <form onSubmit={handleSubmit} className='p-6 space-y-5'>
                ...
                <div>
                    ...
                    <textarea name="reason" rows={3} required id="" className='resize-none'/>
                </div>
